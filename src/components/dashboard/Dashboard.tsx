          ...
          <div className="container mx-auto px-4 lg:px-8 xl:max-w-7xl">
            <div className="flex justify-between border-b-2 border-slate-200/50 py-6">
              ...
              <div className="flex items-center">
                ...
                >
                  <svg
                    className="hi-mini hi-square-3-stack-3d inline-block size-5 rotate-90 text-indigo-500"
              ...
              <div className="flex items-center gap-1 lg:gap-5">
                ...
                <nav className="flex items-center gap-2">
                  <a
                    href="#"
                    className="group flex items-center justify-between rounded-md border border-transparent px-2.5 py-2 text-sm font-semibold text-slate-900 hover:bg-indigo-100 hover:text-indigo-600 active:border-indigo-200 active:bg-indigo-100 sm:gap-2"
                  >
                    <svg
                      className="hi-mini hi-flag inline-block size-5 text-slate-300 group-hover:text-indigo-500"
                      xmlns="http://www.w3.org/2000/svg"
                      viewBox="0 0 20 20"
                      fill="currentColor"
                      aria-hidden="true"
                    ...
                    <span className="inline-flex size-6 items-center justify-center rounded-full border border-indigo-200 bg-indigo-50 text-indigo-900">
                      3
                    </span>
                  </a>
                </nav>
                ...
                <div className="relative inline-block">
                  ...
                  {userDropdownOpen && (
                    <div
                      ...
                      className="absolute end-0 mt-2 w-48 rounded-sm shadow-xl shadow-slate-200 ltr:origin-top-right rtl:origin-top-left"
                    >
                      <div className="divide-y divide-slate-100 rounded-sm bg-white ring-1 ring-slate-900/5">
                        <div className="space-y-1 p-2">
                          <a
                            role="menuitem"
                            href="#"
                            className="group flex items-center gap-2 rounded-sm px-3 py-2 text-sm font-medium text-slate-900 hover:bg-slate-100 hover:text-slate-700"
                          >
                            <svg
                              xmlns="http://www.w3.org/2000/svg"
                              viewBox="0 0 20 20"
                              fill="currentColor"
                              aria-hidden="true"
                              className="hi-mini hi-beaker inline-block size-5 text-slate-300 group-hover:text-indigo-500"
                            >
                              <path
                                fillRule="evenodd"
                          ...
                          >
                            <svg
                              ...
                              viewBox="0 0 20 20"
                              xmlns="http://www.w3.org/2000/svg"
                              className="hi-solid hi-inbox inline-block size-5 text-slate-300 group-hover:text-indigo-500"
                            >
                              <path
                                fillRule="evenodd"
                        ...
                        <div className="space-y-1 p-2">
                          ...
                          >
                            <svg
                              ...
                              viewBox="0 0 20 20"
                              xmlns="http://www.w3.org/2000/svg"
                              className="hi-solid hi-user-circle inline-block size-5 text-slate-300 group-hover:text-indigo-500"
                            >
                              <path
                                fillRule="evenodd"
            ...
            <div className="grid grid-cols-1 md:gap-20 lg:grid-cols-12">
                ...
                <div className="space-y-1.5">
                  ...
                  >
                    <svg
                      ...
                      viewBox="0 0 20 20"
                      xmlns="http://www.w3.org/2000/svg"
                      className="hi-solid hi-user-circle inline-block size-5 flex-none text-slate-300 group-hover:text-indigo-500"
                    >
                      <path
                        fillRule="evenodd"
                        d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-6-3a2 2 0 11-4 0 2 2 0 014 0zm-2 4a5 5 0 00-4.546 2.916A5.986 5.986 0 0010 16a5.986 5.986 0 004.546-2.084A5 5 0 0010 11z"
                  ...
                  >
                    <svg
                      className="hi-mini hi-lock-closed inline-block size-5 flex-none text-slate-300 group-hover:text-indigo-500"
                      xmlns="http://www.w3.org/2000/svg"
                      viewBox="0 0 20 20"
                      fill="currentColor"
                      aria-hidden="true"
              ...
              <div className="lg:col-span-9">
                <div className="grid grid-cols-1 gap-4 sm:grid-cols-12 md:gap-6">
                  {/* Statistics Cards */}
                  {[
                    { value: "63", label: "Accounts today" },
                    { value: "6", label: "Sales today" },
                    { value: "5", label: "Open Tickets" },
                    { value: "10", label: "Pending Invoices" },
                  ].map((stat, index) => (
                    <div
                      key={index}
                        ...
                        <table className="min-w-full align-middle text-sm">
                          <thead>
                            <tr className="border-b-2 border-slate-100">
                              ...
                              <th className="hidden px-3 py-2 text-start text-sm font-semibold tracking-wider text-slate-700 uppercase md:table-cell">
                                Email
                              </th>
                              <th className="hidden px-3 py-2 text-start text-sm font-semibold tracking-wider text-slate-700 uppercase md:table-cell">
                                Status
                              </th>
                              <th className="px-3 py-2 text-end text-sm font-semibold tracking-wider text-slate-700 uppercase">
                                Total
                              </th>
                            </tr>
                          </thead>
                            ...
                            {[
                              ...
                              >
                                ...
                                <td className="hidden p-3 text-start md:table-cell">
                                  <div
                                    className={`inline-block rounded-full border px-2 py-1 text-xs leading-4 font-semibold ${
                                      sale.status === "Pending"
